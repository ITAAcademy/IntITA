...
CKEDITOR.editorConfig = function( config ) {
    ...
    config.extraPlugins = 'mention,eqneditor,pastebase64,youtube,audio,skipWord1,skipWord0,' +
        'a_number,a_date,a_description,a_summa,a_invoices,a_service_hours,a_sum_string,a_start_end_date,u_user_passport,u_user_passport_issued,u_user_passport_date,u_user_inn,u_user_data_address,u_name,c_title,' +
        ...
        'c_edpnou,c_bank_name,c_bank_code,c_legal_address,c_contacts,c_kved,c_checking_account,c_license,c_license_issued,c_license_issued_date,u_user_phone,u_user_email,RightSpan';
