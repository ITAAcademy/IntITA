<div class="panel panel-default" ng-controller="bannersCtrl">
    <button class="btn btn-success"
            ng-bootbox-title="Завантажити банер"
            ng-bootbox-options="dialogOptions"
            ng-bootbox-custom-dialog
            ng-bootbox-custom-dialog-template="/angular/js/teacher/templates/bannerUploadTemplate.html"
    >
        Завантажити банер
    </button>
    <div class="panel-body">
        <div class="dataTable_wrapper">
            <table ng-table="bannersTableData" class="table table-striped table-bordered table-hover"
