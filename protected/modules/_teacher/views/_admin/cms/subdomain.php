    ...
    <form name='subdomainForm'>
        <div class="grid">
            <div>
                ...
                <div class="row">
                    <input class="form-control" type="text" ng-required="true" ng-pattern="/^[a-zA-Z0-9_]+$/"
                           ng-minlength="1" ng-maxlength="15" placeholder="" ng-model="name">
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <button class="btn btn-primary" ng-click="addSubdomain(name)" ng-disabled="subdomainForm.$invalid">
                        Створити
                    </button>
                </div>
            </div>
