...
<?php if (Yii::app()->user->model->canSetGlobalRole()) { ?>
    <a type="button" class="btn btn-primary" ng-href="#/apiKeyManager/addrole/api_key_manager">
        Призначити Api Key Manager'а
    </a>
<?php } ?>
<br>
<br>
<div class="panel panel-default" ng-controller="apiKeyManagerTableCtrl">
    <div class="panel-body">
        <div class="dataTable_wrapper">
            <table ng-table="apiKeyManagerTableParams" class="table table-bordered table-striped table-condensed">
                <colgroup>
                    <col width="20%"/>
                    <col/>
                    <col width="20%"/>
                ...
                <tr ng-repeat="row in $data track by $index">
                    ...
                    <td data-title="''">
                        ...
                        <?php if (Yii::app()->user->model->canSetGlobalRole()) { ?>
                            <a ng-if="!row.end_date" ng-click="cancelRoleByDirector(row.id_user,'api_key_manager')" title="Скасувати">
