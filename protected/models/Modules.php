...
class Modules extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('module_duration_hours, module_duration_days', 'numerical', 'integerOnly'=>true),
			array('module_name', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('module_ID, module_name, module_duration_hours, module_duration_days', 'safe', 'on'=>'search'),
		);
	}
