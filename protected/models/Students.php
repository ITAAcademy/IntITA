...
class Students extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('first_name, middle_name, last_name, tel, email, address, date_of_birth, gender, date_joined, country', 'required'),
			...
			array('student_id, first_name, middle_name, last_name, tel, email, address, date_of_birth, gender, date_joined, country', 'safe', 'on'=>'search'),
		);
	}
