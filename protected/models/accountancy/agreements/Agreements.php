...
//        'payment_schema' => 'paymentSchema.name',
    ...
    public function getUserAgreement($agreementId) {
        $agreement = UserAgreements::model()->with('user', 'approvalUser', 'cancelUser', 'paymentSchema','invoice','internalPayment','corporateEntity','checkingAccount','actualWrittenAgreement')->findByPk($agreementId);
