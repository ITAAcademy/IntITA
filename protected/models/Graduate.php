...
//        if ($selector == 'rating') $criteria->order = 'rate.rating DESC';
    ...
    public function alumniDataAPI()
    {
        ...
        ->select('u.id, u.firstName, u.middleName, u.secondName, u.email, CONCAT(ava.value, \'/\', u.avatar) as avatar, g.position, g.work_place, g.graduate_date, g.recall')
        ->from('graduate g')
